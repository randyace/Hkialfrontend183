...
export function VisitHistory() {
  ...
  const stats = {
    ...
    totalPoints: visits.reduce(
      (acc, v) => acc + v.pointsEarned,
      0,
    ),
    avgRating: (
      visits.reduce((acc, v) => acc + v.rating, 0) /
      visits.length
    ).toFixed(1),
  ...
  const filteredVisits = visits.filter((visit) => {
    const matchesSearch =
      ...
      visit.flight
        ...
        .includes(searchTerm.toLowerCase());
    const matchesYear =
      filterYear === "all" || visit.date.startsWith(filterYear);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl p-6" style={glassStyle}>
          <h2
            className="text-xl flex items-center gap-2 mb-4"
            style={{ color: colors.text }}
          >
            ...
            <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <p
                  ...
                  style={{ color: colors.textMuted }}
                >
                  Check-in: {visit.checkIn} • Check-out:{" "}
                  {visit.checkOut}
                </p>
              </div>
            </div>
