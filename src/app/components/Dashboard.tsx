...
export function Dashboard() {
  ...
  const getStatusColor = (status) => {
    if (mode === 'dark') {
      switch (status) {
        ...
        case 'processing': return 'bg-blue-500/20 text-blue-300 border border-blue-500/30';
  ...
  const BackendStatusIndicator = () => {
    let statusClassName = 'flex items-center gap-2 px-4 py-2 rounded-xl text-sm ';
    if (backendStatus.available) {
      statusClassName += mode === 'dark' ? 'bg-green-500/20 text-green-300 border border-green-500/30' : 'bg-green-100 text-green-700 border border-green-200';
    } else {
      statusClassName += mode === 'dark' ? 'bg-blue-500/20 text-blue-300 border border-blue-500/30' : 'bg-blue-100 text-blue-700 border border-blue-200';
    }
    ...
    return (
      <div className="space-y-6">
        <div className="rounded-2xl p-8 shadow-xl text-center" style={glassStyle}>
          ...
          <button 
            onClick={refreshData}
            className="px-4 py-2 bg-gradient-to-r from-[rgb(220,181,21)] to-[rgb(180,140,10)] text-white rounded-xl hover:shadow-lg transition-all duration-200"
          >
            Try Again
          </button>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Premium lounge management and guest services.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105" style={glassStyle}>
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 bg-gradient-to-br from-[rgb(220,181,21)] to-[rgb(180,141,11)] rounded-xl flex items-center justify-center shadow-lg">
                ...
                <div key={index} className="flex items-center justify-between p-3 bg-white/5 border border-white/10 rounded-xl">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-16 h-2 bg-gray-200 rounded-full">
                      <div 
                        className="h-2 bg-gradient-to-r from-[rgb(220,181,21)] to-[rgb(180,140,10)] rounded-full transition-all duration-300"
