    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-[rgb(220,181,21)] to-[rgb(180,141,11)] text-white rounded-xl hover:shadow-lg transition-all duration-200 flex items-center gap-2"
        >
      ...
      {filteredJobs.length > 0 ? (
        ...
        <div className="text-center py-12">
          <div className="w-24 h-24 bg-gradient-to-br from-[rgb(220,181,21)]/20 to-[rgb(180,141,11)]/20 rounded-full flex items-center justify-center mx-auto mb-4">
            <Briefcase className="w-12 h-12 text-[rgb(220,181,21)]" />
          </div>
